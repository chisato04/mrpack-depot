...
<body>
        ...
        <div class="sidebar-card">
            ...
            <div class="filter-group">
                ...
                <div class="filter-buttons">
                    ...
                    <?php foreach ($unique_loaders as $loader): ?>
                        <button class="filter-btn" data-filter-group="loader"
                            data-filter="<?php echo htmlspecialchars($loader); ?>"><?php echo htmlspecialchars($loader); ?></button>
                    <?php endforeach; ?>
                </div>
            </div>
            <div class="filter-group">
                ...
                <div class="filter-buttons">
                    ...
                    <?php foreach ($unique_versions as $version): ?>
                        <button class="filter-btn" data-filter-group="version"
                            data-filter="<?php echo htmlspecialchars($version); ?>"><?php echo htmlspecialchars($version); ?></button>
                    <?php endforeach; ?>
                </div>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            // Make card divs clickable
            const clickableCards = document.querySelectorAll('.card');
            clickableCards.forEach(card => {
                card.addEventListener('click', (event) => {
                    // Prevents firing if the click was on the download button
